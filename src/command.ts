...
/**
 * Signal type for killing commands
 */
export type Signal = "SIGTERM" | "SIGKILL" | "SIGINT" | NodeJS.Signals;
...
export class Command {
  ...
  constructor(params: { sandboxId: string; cmd: CommandData }) {
   ...
   */
  async *logs(opts?: { signal?: AbortSignal }): AsyncGenerator<{
    data: string;
...
export class CommandFinished extends Command {
  ...
  constructor(params: { sandboxId: string; cmd: CommandData; exitCode: number }) {
